 ...
 */
export const getTeacherHomework = async ( options?: RequestInit): Promise<GetTeacherHomework200Item[]> => {

  return customFetch<GetTeacherHomework200Item[]>(getGetTeacherHomeworkUrl(),
  {
    ...options,
    method: 'GET'
